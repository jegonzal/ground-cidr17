...
\newcommand{\joey}[1]{{\textcolor{cyan}{[[#1 -- joey]]}}}
...
\joey{What are the problems? Could we introduce the ``Vs'' of meta-data management: Discovery, Provenance, Attribution, Context ... }
