...
profound shift towards highly decoupled data systems. 
...
An insidious consequence of the disaggregated big data systems 
% architecture
...
%, which---combined with the append-only nature of HDFS---makes it possible to ``time travel'' to view Hive tables as they appeared in the past.
...
\jmh{The HDFS crawl doesn't really feel like it fits into the time travel; is it used to access the past? If not maybe skip the ETL point and move this up to the Hive Metastore bullet}.
...
can  provide ``time travel'' for Hive queries. 
