...
Before she gets started, Sue examines the code responsible for the news feed and discovers that it pulls content from several different HIVE tables \verb|user_fin| and \verb|ad_posts1| and relies the on the fields \verb|vis_2|, \verb|score3|, and \verb|features_2| when determining how content is ordered. 
Sue, curious about how these tables are populated, asks her team members who tell her about the intern that created the original cron jobs and warn her to be careful when changing the input tables.
